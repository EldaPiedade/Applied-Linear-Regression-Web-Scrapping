...
After splitting the data into 4 groups and repeated the fold cross-validation by 12, the best model is LS0 which is y~x1+x3+x5+x7, therefore our completed model shoudl be:

y_hat = 1.210e+01 -1.258e-05x1(Total.Population) + 1.382e-05x3(Median.Household.Income) + 3.717e-05x5(Total.Housing.Units) -6.015e-03x7(Housing.Affordability.Index2)
